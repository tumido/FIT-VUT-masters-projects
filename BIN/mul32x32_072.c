...
// Circuit = mul32x32_072
// Area   (45) = 794
// Delay  (45) = 1.620
// Power  (45) = 0.46
// MAE = 43916470950142072.0
// MRE = 89.18 %
// WCE LIMIT = 3689348814741910323200
// WCE LIMIT % = 2 %
// EP = 100.0 %
#include <stdint.h>
inline uint64_t mul32x32_072(uint32_t opA, uint32_t opB) {
  ...
  int sig_658 = A[11];
  int sig_669 = ~ (sig_658 & sig_187);
  int sig_681 = ~ B[2];
  int sig_683 = A[30] & B[27];
  int sig_692 = ~ (B[25] & sig_146);
  ...
  int sig_1101 = B[20];
  int sig_1128 = ~ sig_236;
  int sig_1138 = ~ (sig_1128 | sig_577);
  int sig_1162 = ~ A[29];
  ...
  int sig_1343 = ~ sig_162;
  int sig_1350 = sig_692;
  ...
  int sig_1569 = sig_1162 & sig_985;
  int sig_1575 = ~ sig_580;
  int sig_1617 = sig_88;
  int sig_1641 = sig_683 & sig_654;
  int sig_1668 = sig_1265 ^ sig_1361;
  int sig_1679 = ~ sig_894;
  int sig_1680 = sig_1280 & sig_311;
  ...
  int sig_1847 = ~ sig_192;
  int sig_1924 = sig_403 & sig_864;
  ...
  int sig_2683 = sig_1569 | sig_2360;
  ...
  int sig_3687 = ~ sig_1617;
  int sig_3692 = sig_1445 & sig_599;
  ...
  int sig_4198 = ~ sig_1138;
  int sig_4230 = sig_3849 ^ sig_735;
  int sig_4243 = ~ (sig_204 & A[26]);
  int sig_4264 = sig_4062;
  ...
  int sig_4557 = ~ sig_1101;
  int sig_4569 = ~ sig_3857;
